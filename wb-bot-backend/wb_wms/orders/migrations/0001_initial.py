# Generated by Django 4.2 on 2025-03-18 12:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "container_type",
                    models.CharField(
                        choices=[("Коробка", "Коробка"), ("Паллета", "Паллета")],
                        max_length=255,
                    ),
                ),
                (
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "cargo_type",
                    models.CharField(max_length=50, verbose_name="Тип груза"),
                ),
                (
                    "container_type",
                    models.CharField(
                ...
                (
                    "company",
                    models.CharField(
                        blank=True, max_length=255, null=True, verbose_name="Компания"
                    ),
                ),
                (
                    "email",
